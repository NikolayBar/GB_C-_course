...
string[] WorkingTime = new string[5] { "09-10", "10-11", "11-12", "12-13", "13-14" };//рабочие часы
...
Console.WriteLine($"Наибольшее количество посетителей ({max} чел.) ");
Console.WriteLine($"находилось в магазине в период {MaxPeopleTime} час.");
Console.WriteLine();
Console.ForegroundColor=ConsoleColor.White;
Console.WriteLine(String.Join("|",WorkingTime)+"|");
PrintArray(ListOfIncoming);
Console.Write(" - зашло покупателей\n");
PrintArray(ListOfOutput);
Console.Write(" - вышло покупателей\n");
Console.ReadKey();
